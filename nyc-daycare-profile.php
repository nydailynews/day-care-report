...
<html lang="en">
  ...
  <meta charset="utf-8" />
    ...
    <link rel="icon" 
      type="image/png" 
      href="http://interactive.nydailynews.com/favicons.png">
 

    <meta property="og:title" content="How safe is your child’s New York City day care?" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="http://assets.nydailynews.com/polopoly_fs/1.2527187!/img/httpImage/390-daycare-map-0210.jpg" />
    <meta property="og:image:width" content="400" />
    <meta property="og:image:height" content="267" />
    <meta property="og:url" content="http://interactive.nydailynews.com/2016/02/nyc-day-care-interactive-map-how-safe-is-your-child/index.html" />
    <meta property="og:description" content="Find the safety violations at your child’s NYC day care with the New York Daily News’ interactive map." />
    ...
    <div id="box">
        <header id="nydn-header">
              <div id="nydn-header-wrap">
                ...
                <img  id="header_line" src="http://interactive.nydailynews.com/includes/media/header_line.png">
                <h1 id="interactive-logo">
                <a>INTERACTIVE</a></h1>
                <nav id="nydn-menu">
...
<div id="hed" class=""><img src="images/nydn-daycare1200.png" /></div><br/>
<div id="hed" class=""><?php echo $_GET['name'];?></div>
<div id="dek" class=""><?php echo $_GET['address']."<br>". $_GET['city'].", NY";?></div>
<br>
<div id="dek">These violations were issued by the <a href="https://a816-healthpsi.nyc.gov/ChildCare/SearchAction2.do">New York City Department of Health and Mental Hygiene</a>. The data is being provided from their website. </div><br/>
<div style="text-align:center;font-size:1.2em"><a  href="http://interactive.nydailynews.com/2016/02/nyc-day-care-interactive-map-how-safe-is-your-child/index.html" target="_self">BACK TO SEARCH</a></div>
 <div id="social" align="center" class="row">
  
                  <a class="fb-share" href="http://www.facebook.com/sharer.php?u=http://interactive.nydailynews.com/2016/02/nyc-day-care-interactive-map-how-safe-is-your-child/index.html" target="_blank"><div id="facebook" class="small-text-center"></div></a>
                  
                  <a href="https://twitter.com/share?url=nydn.us/daycaremap&text=How safe is your child? Find day care safety violations with our interactive map. nydn.us/daycaremap @nydailynews" target="_new"><div id="twitter"></div></a>

                    
                  <a href="mailto:?subject=How safe is your child’s day care?&body=I searched for violations at <?php echo $_GET['name'];?> with the New York Daily News’ interactive map. Here’s what I found: <?php  echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>"><div id="email"></div></a> 
...
<div class="row">
<?php
// Make sure that we're publishing an iframe to a site on a nyc.gov domain.
// The domain will be in the third item of the array.
$link = '';
$link_chunks = explode('/', $_GET['link']);
if ( strpos($link_chunks[2], 'nyc.gov') > 0 ):
	$link = $_GET['link'];
endif;
?>
 <iframe src="<?php echo $link;?>&type=comparison" width="100%" height="2000px" style="border: 1px solid #eee;"></iframe>
</div>
